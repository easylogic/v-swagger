(function (global, factory) {
            ...
            (function () {
                if (typeof document !== 'undefined') {
                    var head = document.head || document.getElementsByTagName('head')[0],
                        style = document.createElement('style'),
                        css = ".api[data-v-13776bac] { /* background-color: yellow; */ } .api .header[data-v-13776bac] { display: flex; align-items: center; padding: 10px 20px 10px 10px; cursor: pointer; transition: all .2s; border-bottom: 1px solid rgba(59, 65, 81, 0.3); font-size: 24px; margin: 0 0 5px; font-family: sans-serif; color: #3b4151; } .api .header .host[data-v-13776bac] { font-size: 14px; font-weight: 400; padding: 0 10px; font-family: sans-serif; color: #3b4151; flex: 1; } .api .header .title[data-v-13776bac] { font-weight: 700; } .api .header .description[data-v-13776bac] { font-size: 14px; font-weight: 400; flex: 1; padding: 0 10px; font-family: sans-serif; color: #3b4151; text-align: right; } ";style.type = 'text/css';if (style.styleSheet) {
                        style.styleSheet.cssText = css;
                    } else {
                        style.appendChild(document.createTextNode(css));
                    }head.appendChild(style);
...
//# sourceMappingURL=v-swagger.umd.js.map
